  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-20 lg:py-24 bg-secondary/30 relative overflow-hidden">
             <div className="absolute top-0 -left-4 w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
            <div className="absolute top-0 -right-4 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
            <div className="absolute -bottom-8 left-20 w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
          <div className="container px-4 md:px-6 relative">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <h1 className="text-4xl md:text-5xl font-bold tracking-tighter text-primary animate-fade-in-up">About Us</h1>
              <p className="max-w-3xl text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed animate-fade-in-up [animation-delay:200ms]">
        ...
        <section id="mission" className="w-full py-12 md:py-24 lg:py-32">
            <div className="container px-4 md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                    <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-balance animate-fade-in-up">Our Mission</h2>
                </div>
                <Card className="bg-secondary/30 border-border/50 shadow-lg animate-fade-in-up [animation-delay:200ms]">
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {features.map((feature, i) => (
                <Card 
                  key={feature.title}
                  className="group flex flex-col h-full bg-background/50 border-border shadow-md animate-fade-in-up"
        ...
        <section id="mentors" className="w-full py-12 md:py-24 lg:py-32">
            ...
            <div className="container px-4 md:px-6 relative">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                     <Card className="bg-secondary/30 border-border/50 shadow-lg animate-fade-in-up [animation-delay:300ms]">
                        <CardHeader>
                    ...
                    <Card className="bg-secondary/30 border-border/50 shadow-lg animate-fade-in-up [animation-delay:450ms]">
                       <CardHeader>
        ...
        <section id="contact" className="w-full py-12 md:py-24 lg:py-32 bg-secondary/30">
          <div className="container px-4 md:px-6">
            <Card className="bg-background/50 border-border shadow-xl animate-fade-in-up">

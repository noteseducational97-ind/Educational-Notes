...
import { GenerateTestInput, GenerateTestOutput } from './test-maker-flow';

// Re-exporting types from the main test maker flow
export { type GenerateTestInput, type GenerateTestOutput };
...
1.  **20 Multiple Choice Questions**: Each question must have 4 options (A, B, C, D).
...
Formatting Rules:
- Format each question as "1. Question text... A) Option A B) Option B C) Option C D) Option D".
